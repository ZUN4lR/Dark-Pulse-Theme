...
2. Go to **Extensions** (
    <img src="https://www.microsoft.com/favicon.ico" width=16 height=16/> , <img src="https://www.kernel.org/theme/images/logos/favicon.png" width=20 height=20/> `Ctrl+Shift+X` / <img src="https://developer.apple.com/favicon.ico" width=20 height=20/> `⌘+Shift+X`).
